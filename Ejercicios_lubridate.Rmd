...
t
```
**Es importante la clase de date_time** (son las implementaciones internas de date-time):   
La clase **POSIXct** almacena internamente esta cifra como un número entero, mientras que la clase **POSIXlt** la descompone en una lista con elementos para los segundos, minutos, horas, día, mes y año.
