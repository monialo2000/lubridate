...
## Intervalos:
Interval es un difftime (un lapso) con una fecha exacta de inicio.(a diferencia de duration). Lo cual nos permite operar con fechas exactas, sin molestar los bisiestos.
